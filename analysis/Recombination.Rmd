...
grid.arrange(p[[1]],p[[2]],p[[3]],p[[4]],p[[5]], ncol=5,top = textGrob("Recombination events of GBRS282 Genotypes in different sigmas",gp=gpar(fontsize=12,font=2)))
