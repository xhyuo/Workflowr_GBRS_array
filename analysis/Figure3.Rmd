...
```{r Figure 3 Trans-eQTL at FDR 0.05 5Mb, message=FALSE, eval=TRUE,fig.height=20, fig.width=20}
...
```{r Figure 3 Trans-eQTL at LOD 8 5Mb, message=FALSE, eval=TRUE,fig.height=20, fig.width=20}
a1 = a2 = a3 = n12 = n13 = n23 = n123 = list()
load("/projects/heh/HH/GBRS_array/data/gene.anno.cis.RData")
#load eqtl pvalue for muga275
a <- get(load("/projects/heh/HH/GBRS_array/Workflowr_Array_GBRS/analysis/eqtl_with_perms/muga275/muga275_pvalue.RData"))
...
a$cis_trans_max <- ifelse(a$nearest_marker == a$eqtl_marker, "cis", "trans")
a$cis_trans_location <- ifelse((a$chr.y == a$chr.x) & (abs(a$pos - a$start) <= 5e+06) & (abs(a$pos - a$end) <= 5e+06),"cis", "trans")
a <- a[a$cis_trans_location == "trans",]
...
b$cis_trans_max <- ifelse(b$nearest_marker == b$eqtl_marker, "cis", "trans")
b$cis_trans_location <- ifelse((b$chr.y == b$chr.x) & (abs(b$pos - b$start) <= 5e+06) & (abs(b$pos - b$end) <= 5e+06),"cis", "trans")
b <- b[b$cis_trans_location == "trans",]
...
c$cis_trans_max <- ifelse(c$nearest_marker == c$eqtl_marker, "cis", "trans")
c$cis_trans_location <- ifelse((c$chr.y == c$chr.x) & (abs(c$pos - c$start) <= 5e+06) & (abs(c$pos - c$end) <= 5e+06),"cis", "trans")
c <- c[c$cis_trans_location == "trans",]
...
save(a1,a2,a3,n12, n13, n23, n123, file = "/projects/heh/HH/GBRS_array/Workflowr_Array_GBRS/output/venn_diag_transeqtl_lod8.RData")

load("/projects/heh/HH/GBRS_array/Workflowr_Array_GBRS/output/venn_diag_transeqtl_lod8.RData")
#bar plot
barplot(c(a3[[1]],a3[[2]],a3[[3]]),
...
# Figure 3 Trans-eQTL at FDR 0.05 (2 Mb)
```{r Figure 3 Trans-eQTL at FDR 0.05 2Mb, message=FALSE, eval=TRUE,fig.height=20, fig.width=20}
a1 = a2 = a3 = n12 = n13 = n23 = n123 = list()
load("/projects/heh/HH/GBRS_array/data/gene.anno.cis.RData")
#load eqtl pvalue for muga275
a <- get(load("/projects/heh/HH/GBRS_array/Workflowr_Array_GBRS/analysis/eqtl_with_perms/muga275/muga275_pvalue.RData"))
...
a <- merge(a, gene.anno, by.x=c("genes"), by.y=c("gene"), all.x = TRUE)
a$cis_trans_max <- ifelse(a$nearest_marker == a$eqtl_marker, "cis", "trans")
a$cis_trans_location <- ifelse((a$chr.y == a$chr.x) & (abs(a$pos - a$start) <= 2e+06) & (abs(a$pos - a$end) <= 2e+06),"cis", "trans")
a <- a[a$max_qvalue <= 0.05 & a$cis_trans_location == "trans",]
...
b <- merge(b, gene.anno, by.x=c("genes"), by.y=c("gene"), all.x = TRUE)
b$cis_trans_max <- ifelse(b$nearest_marker == b$eqtl_marker, "cis", "trans")
b$cis_trans_location <- ifelse((b$chr.y == b$chr.x) & (abs(b$pos - b$start) <= 2e+06) & (abs(b$pos - b$end) <= 2e+06),"cis", "trans")
b <- b[b$max_qvalue <= 0.05 & b$cis_trans_location == "trans",]
...
c <- merge(c, gene.anno, by.x=c("genes"), by.y=c("gene"), all.x = TRUE)
c$cis_trans_max <- ifelse(c$nearest_marker == c$eqtl_marker, "cis", "trans")
c$cis_trans_location <- ifelse((c$chr.y == c$chr.x) & (abs(c$pos - c$start) <= 2e+06) & (abs(c$pos - c$end) <= 2e+06),"cis", "trans")
c <- c[c$max_qvalue <= 0.05 & c$cis_trans_location == "trans",]
...
# Figure 3 Trans-eQTL at LOD >=8 (2 Mb)
```{r Figure 3 Trans-eQTL at LOD 8 2Mb, message=FALSE, eval=TRUE,fig.height=20, fig.width=20}
a1 = a2 = a3 = n12 = n13 = n23 = n123 = list()
load("/projects/heh/HH/GBRS_array/data/gene.anno.cis.RData")
#load eqtl pvalue for muga275
a <- get(load("/projects/heh/HH/GBRS_array/Workflowr_Array_GBRS/analysis/eqtl_with_perms/muga275/muga275_pvalue.RData"))
